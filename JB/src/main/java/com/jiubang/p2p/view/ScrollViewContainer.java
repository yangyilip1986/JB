...
public class ScrollViewContainer extends RelativeLayout {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		case 0:
			...
			break;
		case 1:
			bottomView.layout(0, topView.getMeasuredHeight() + (int) mMoveLen - getHeightTitle(), mViewWidth, topView.getMeasuredHeight() + (int) mMoveLen + bottomView.getMeasuredHeight());
			break;
		}
    }
