...
public class KJListViewFooter extends LinearLayout {
    ...
    public KJListViewFooter(Context context, String refreshing) {
    	super(context);
    ...
    private void initView(Context context) {
        ...
        contentView.setLayoutParams(new RelativeLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));
